...
// // //   const outdoor = {
// // //     clear: [
// // //       { text: "Perfect weather for a hike or picnic!", severity: "info", time: "7:00 AM" },
// // //       { text: "Hydrate well and wear a hat if outside long.", severity: "warning", time: "11:00 AM" },
// // //     ],
// // //     rain: [
// // //       { text: "Rainy conditions: Postpone hiking plans.", severity: "warning", time: "8:00 AM" },
// // //     ],
// // //     thunderstorm: [
// // //       { text: "Thunderstorm risk: Avoid open fields and tall trees.", severity: "critical", time: "9:30 AM" },
// // //     ],
// // //     clouds: [
// // //       { text: "Cool and cloudy: Great for a jog!", severity: "info", time: "6:45 AM" },
// // //     ],
// // //     mist: [
// // //       { text: "Visibility is low: Avoid running or biking in unfamiliar areas.", severity: "warning", time: "7:30 AM" },
// // //     ]
// // //   };

// // //   return (
// // //     <div>
// // //       {outdoor[condition]?.map((note, index) => (
...
// // import React from 'react';
// // import { WiDaySunny, WiRain, WiThunderstorm, WiCloudy, WiFog } from 'react-icons/wi';
...
// //         <div key={index} className={`flex items-start gap-3 p-3 mb-2 rounded-lg shadow-md border-l-4 ${note.severity === "info" ? "border-blue-300 bg-blue-50" : note.severity === "warning" ? "border-yellow-400 bg-yellow-50" : "border-red-500 bg-red-50"}`}>
// //           <div className="mt-1">{severityIcon[note.severity]}</div>
// //           <div>
// //             <p className="text-sm font-medium text-gray-700"><strong>{note.time}:</strong> {note.text}</p>
// //           </div>
// //         </div>
// //       ))}
// //     </div>
...
//         <div
//           key={index}
//           className={`flex items-start gap-3 p-3 mb-3 rounded-lg shadow-md border-l-4 ${
//             note.severity === 'info'
