...
// //   return (
// //     <div>
// //       {travels[condition]?.map((note, index) => (
...
//   // Get notifications based on weather condition
//   const notes = travels[condition] || [];

//   return (
//     <div className="p-6 max-w-xl mx-auto bg-white rounded-xl shadow-lg">
//       {/* Weather Icon and Condition */}
//       <div className="flex items-center gap-2 mb-4">
//         {iconMap[condition] || iconMap.clear} {/* Default icon if condition is invalid */}
