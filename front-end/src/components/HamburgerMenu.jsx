...
// const HamburgerMenu = ({ weather, notificationMessage }) => {
...
//   const notificationExists = weatherNotifications[effectiveWeatherCondition]?.length > 0;
...
//         {isSubmenuOpen ? (
//           <FaArrowLeft
//             className={`text-xl ${currentTheme === "neon" ? "text-white" : "text-white"}`}
//           />
//         ) : (
//           <>
//             <div
...
//               } ${currentTheme === "neon" ? "bg-[#39ff14]" : "bg-white"}`}
//             />
//             <div
//               className={`absolute w-full h-[5px] rounded transition-all duration-300 ${
...
//         {!isSubmenuOpen && notificationVisible && notificationExists && (
...
//             <FaBell />
//             Notification
//             {notificationVisible && notificationExists && (
...
//           </div>
//           <div
//             className="flex items-center gap-4 px-5 py-4 text-lg font-semibold cursor-pointer"
//             onClick={() => toggleMenu("themes")}
//             role="button"
//             tabIndex={0}
//             onKeyDown={(e) => e.key === "Enter" && toggleMenu("themes")}
//           >
//             <FaPalette /> Theme
//           </div>
//           <div
...
//             role="button"
//             tabIndex={0}
//             onKeyDown={(e) => e.key === "Enter" && toggleMenu("settings")}
//           >
//             <FaCog /> Settings
//           </div>
//           <div
...
//             role="button"
//             tabIndex={0}
//             onKeyDown={(e) => e.key === "Enter" && toggleMenu("history")}
//           >
//             <FaHistory /> History
//           </div>
//         </div>
...
//       {/* Show current city name and weather */}
...
// // // // //         <NotificationMenu weather={weather} />
// // // // //       )} */}
...
// // // // //     <h4>{weather.name}</h4>
// // // // //     <p>{weather.main.temp}°C - {weather.weather[0].main}</p>
// // // // //     <AgriculturalUsers condition={weather.weather[0].main.toLowerCase()} />
// // // // //   </div>
// // // // // )} */}
...
// //           </>
// //         )}
// //         {notificationVisible && notificationExists && !isSubmenuOpen && (
// //           <div className="absolute top-[-5px] right-[-5px] bg-red-600 text-white rounded-full text-xs w-4 h-4 flex items-center justify-center">
// //             !
// //           </div>
// //         )}
...
//     clear: ["Clear skies: Enjoy the sun"],
//   };
//   const showNotificationBadge = notificationVisible && weatherNotifications[effectiveWeatherCondition]?.length > 0;
